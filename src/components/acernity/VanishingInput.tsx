...
export function PlaceholdersAndVanishInput({
    ...
    return (
        ...
        >
            ...
            />
            <label htmlFor="file" className="absolute right-12 top-1/2 z-50 -translate-y-1/2">
                <svg width="24" height="24" viewBox="0 0 24 24" className="size-5" fill="none" xmlns="http://www.w3.org/2000/svg">
